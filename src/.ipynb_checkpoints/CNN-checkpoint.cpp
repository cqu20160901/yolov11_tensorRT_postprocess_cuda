...
void CNN::PrepareImage(cv::Mat &SrcImage, std::vector<float> &PreprocessResult)
{
    ...
    std::cout << "--77777--- test" << std::endl;
    cv::split(rsz_img, split_img);
    std::cout << "--88888--- test" << std::endl;
}
